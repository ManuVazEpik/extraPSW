<%-- 
    Document   : cuentaGerente
    Created on : 1/07/2020, 12:01:04 AM
    Author     : manua
--%>
...
<html>
    ...
    <body>
        ...
        <div>
            ...
            %>
            <form method="post" action="modificarNombre">
                <div class="campo">
                Usuario:
                ...
                <br>
            <form method="post" action="modificarCorreo">
                <div class="campo">
                Correo anterior:
                ...
                <br>
            <form method="post" action="modificarPass">
                <div class="campo">
                Usuario:
                ...
                <br>
                <form method="post" action="modificarDireccion">
                <div class="campo">
                Usuario:
                <input type="text" value="<%=pass%>" readonly="readonly">
                </div>
